...
if(LEADERBOARD_STAT == "RESOURCE") then
	local title =string.upper( string.reverse(string.sub(string.reverse(RESOURCE_NAME),6)))
	print("TITLE .."..title)
	Title.text = string.format("%s %s %s", LEADERBOARD_TYPE, LEADERBOARD_PERSISTENCE, title)
else
